...
from opt_action import dcon, dlin, opt_action
...
def plot_phase_diagram(ax, xparam, beta, nu, pi, tau, psi):
    ...
    size = 1001  # Avoids divide-by-zero visual artifacts for dcon/dlin.
    ...
    # Plot dcon or dlin, the critical points, over the heatmap.
    dfun = dcon if pi == 'constant' else dlin
    if xparam == 'beta':
